...
""" srun -n 1 --gres=gpu:1 --cpus-per-task=15 --partition=ml-all-gpu --output=citeseer-5.txt python -u citeseer-5.py & """
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.gnn_layer = GraphSAGE( input_size, hidden_size, double_layer=True )
